 ...
 * @param devices Device guid list. if applyTo is 2
 * @param entityGuid Entity Guid. if applyTo is 1
 * @param isRecursive Send true to include child entity devices. if applyTo is 1
...
data class CommandScheduleUpdateRequest(
