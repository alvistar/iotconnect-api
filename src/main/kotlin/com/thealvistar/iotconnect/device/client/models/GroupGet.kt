...
/**
 * *
 * @param guid * @param name * @param typeGuid * @param typeName * @param isActive * @param companyGuid * @param isDeleted * @param createdDate * @param createdBy * @param updatedDate * @param updatedBy * @param sphereGroup */
