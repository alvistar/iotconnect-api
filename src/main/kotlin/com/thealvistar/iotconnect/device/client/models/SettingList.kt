...
/**
 * *
 * @param guid * @param name * @param dataTypeGuid * @param createdDate * @param createdby * @param updatedDate * @param localName * @param defaultValue * @param dataValidation * @param tag * @param isReadOnly * @param dataTypeName */
